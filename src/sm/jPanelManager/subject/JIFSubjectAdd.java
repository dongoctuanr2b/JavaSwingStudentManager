 ...
 * @author Ngoc Tuan
 */
public class JIFSubjectAdd extends javax.swing.JInternalFrame {
    ...
    private void fillData() {
        ...
        JPSubjectManager.jTableSubject.setModel(dtm);
    }

    //validate form add course
    private boolean validateSubjectAdd() {
        boolean flag = true;
        ...
        for (Subject subject : subjects) {
            if (jTextFieldSubjectN.getText().toLowerCase().equals(subject.getSubjectName().toLowerCase())) {
                JOptionPane.showMessageDialog(rootPane, "Subject name " + jTextFieldSubjectN.getText() + " already exist!!!", "Warning", JOptionPane.ERROR_MESSAGE);
        ...
        //nếu course name không bị trùng thì flag vẫn = true rồi check tiếp
        if (flag) {
    ...
    private void initComponents() {
        ...
        jLabelSubjectAdd.setText("Add Subject");
                ...
                .addGroup(jPanelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanelAddLayout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(jTextFieldSubjectN, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanelAddLayout.createSequentialGroup()
                            .addComponent(jLabelFee)
                            .addGap(18, 18, 18)
                            .addComponent(jTextFieldFee, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanelAddLayout.createSequentialGroup()
                        .addGap(152, 152, 152)
...
//Check form add course
        if (validateSubjectAdd()) {
            Subject subject = new Subject(
                    jTextFieldSubjectN.getText(),
                    Float.valueOf(jTextFieldFee.getText())
            );

            boolean row = subjectDAO.save(subject);

            if (row) {
                JOptionPane.showMessageDialog(rootPane, "New Subject Added!", "Notification", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(rootPane, "Error Add Subject!!!", "Warning", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private javax.swing.JTextField jTextFieldSubjectN;
