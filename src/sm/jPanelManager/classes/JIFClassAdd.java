 ...
 * @author Ngoc Tuan
 */
public class JIFClassAdd extends javax.swing.JInternalFrame {
    ...
    private boolean validateClassAdd() {
        ...
        for (Classes classes : listClasses) {
            if ((jTextFieldClassN.getText().equalsIgnoreCase(classes.getClassName()))) {
                JOptionPane.showMessageDialog(rootPane, "Class name " + classes.getClassName() + " already exist.", "Warning", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        jLabelClassN = new javax.swing.JLabel();
        jLabelClassAdd = new javax.swing.JLabel();
        ...
        jLabelClassN.setBackground(new java.awt.Color(255, 255, 255));
        jLabelClassN.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        jLabelClassN.setText("Class name:");

        jLabelClassAdd.setBackground(new java.awt.Color(255, 255, 255));
        jLabelClassAdd.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        jLabelClassAdd.setText("Add Class");
        ...
        jLabelNOS.setBackground(new java.awt.Color(255, 255, 255));
        jLabelNOS.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        jLabelNOS.setText("Number of Students:");
            ...
            .addGroup(jPanelAddLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanelAddLayout.createSequentialGroup()
                            .addComponent(jLabelClassN)
                            .addGap(18, 18, 18)
                            .addComponent(jTextFieldClassN, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanelAddLayout.createSequentialGroup()
                            .addComponent(jLabelNOS)
                            .addGap(18, 18, 18)
                            .addComponent(jTextFieldNOS, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanelAddLayout.createSequentialGroup()
                        .addGap(152, 152, 152)
    ...
    private void jButtonSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSaveMouseClicked
        ...
        if (validateClassAdd()) {
            ...
            if (row) {
                ...
                JOptionPane.showMessageDialog(rootPane, "New Class Added!", "Notification", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(rootPane, "Error Add Class!!!", "Warning", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private javax.swing.JLabel jLabelClassAdd;
    private javax.swing.JLabel jLabelClassN;
    private javax.swing.JLabel jLabelNOS;
    private javax.swing.JPanel jPanelAdd;
    private javax.swing.JTextField jTextFieldClassN;
